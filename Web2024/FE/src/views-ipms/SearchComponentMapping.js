...
export const componentMap = {
    ...
    // IP할당관리 > VPN IP현황/ 게시판 > 신청 처리 현황, 요청사항 구분, 진행상태, 이용목적 / 운용정보관리 > WHOIS 정보공개 관리, 유선IP 사전 정보관리
    ...
    // 시설용 IP check option
    FacilitiesOption: () => import('@/views-ipms/conditionComponents/FacilitiesOption.vue'),
}
