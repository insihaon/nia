...
const routeName = 'ModalOperationTeam'
  ...
  data() {
    return {
      ...
      componentList: [
       ...
       tableColumns: [
        { prop: '', label: '선택', align: 'center', sortable: true, columnVisible: true, showOverflow: true },
        { prop: '', label: '운용조직 ID', align: 'center', sortable: true, columnVisible: true, showOverflow: true },
        { prop: '', label: '운용조직 명', align: 'center', sortable: true, columnVisible: true, showOverflow: true },
      ],
    }
  },
  methods: {
