  ...
  >
    <template v-if="viewType === 'detail'">
      <div class="popupContentTable">
        <div class="popupContentTableTitle">화면 정보</div>
        <table>
          <tbody>
            <tr class="top">
              <th>화면ID</th>
    ...
    <div class="popupContentTableBottom">
      <el-button v-if="viewType === 'detail'" type="primary" size="small" icon="el-icon-edit" round @click="viewType = 'edit'">수정</el-button>
      <el-button v-if="viewType !== 'detail'" type="primary" size="small" icon="el-icon-document-add" round @click="fnInsertScrnBas()">등록</el-button>
      <el-button v-if="viewType === 'edit'" type="primary" size="small" icon="el-icon-check" round @click="fnUpdateScrnBas()">저장</el-button>
