  ...
  data() {
    return {
      ...
      componentList: [
        ...
        { key: 'IpAddress', props: {} },
        { key: 'InputType', props: { componentKey: 'smodelname', label: '모델명' } },
        { key: 'InputType', props: { componentKey: 'sipHostNm', label: '장비명' } },
        { key: 'IncludeYN', props: { componentKey: 'sprorityYn', label: '대표여부' } },
        { key: 'InputType', props: { componentKey: 'scomment', label: '용도' } },
        { key: 'SortType', props: { } },
      ],
      tableColumns: [
