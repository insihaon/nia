    ...
    >
      ...
      <table class="basic">
        ...
        <tr>
          <th>노드</th>
          <td class="disable">
            <el-select v-model="src_node_id" :disabled="isDisable">
        ...
        <tr>
          <th>IF IP</th>
          <td class="disable">
            <el-input v-model="src_ip_addr" :disabled="isDisable" placeholder="0.0.0.0" />
          </td>
          <th>IF IP</th>
          <td class="disable">
            <el-input v-model="dest_ip_addr" :disabled="isDisable" placeholder="0.0.0.0" />
          </td>
        </tr>
        <tr>
          <th colspan="1">대역폭</th>
