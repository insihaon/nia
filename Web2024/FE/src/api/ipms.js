...
export const ipmsModelApis = {
  ...
  selectListIpAssignMst: { desc: 'IP주소 노드 이전 신청 > IP 주소 조회', url: '/opermgmt/nodemgmt/selectListIpAssignMst' },
  ...
  deleteReq: { desc: '요구사항 조회 > 삭제', url: '/opermgmt/requiremgmt/deleteReq' },
  insertReq: { desc: '요구사항 조회 > 등록', url: '/opermgmt/requiremgmt/insertReq' },
...
export const ipmsJsonApis = {
  ...
  deletAlcIPMst: { desc: 'IP할당 해지처리', url: '/ipmgmt/allocmgmt/deletAlcIPMst' },
  ...
  viewfnDeleteAlcIPMst: { desc: 'IP주소 노드 이전 신청 > 신청 팝업 IP조회 > 해지', url: '/opermgmt/nodemgmt/viewfnDeleteAlcIPMst' },
  viewDeleteNode: { desc: 'IP주소 노드 이전 신청 > 상세 > 신청취소', url: '/opermgmt/nodemgmt/viewDeleteNode' },
  viewCancelNode: { desc: 'IP주소 노드 이전 > 상세 > 반려', url: '/opermgmt/nodemgmt/viewCancelNode' },
  confirmNode: { desc: 'IP주소 노드 이전 > 상세 > 승인', url: '/opermgmt/nodemgmt/confirmNode' },
