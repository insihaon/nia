describe('Ip Assign Fuctionality', () => {
  ...
  context('IP Assign View List', () => {
    ...
    it('assign', () => {
      ...
      cy.get('tbody > :nth-child(1) > .el-table_2_column_12 > .cell > .el-checkbox > .el-checkbox__input > .el-checkbox__inner').click()
      ...
      cy.wait(500)
      cy.get('[style="min-width: 270px; position: fixed; top: 329px; left: 1200px; transform-origin: center top; z-index: 2003;"] > .el-scrollbar > .el-select-dropdown__wrap > .el-scrollbar__view > :nth-child(2)').click()
    ...
    it('return', () => {
      ...
      cy.wait(300)
      cy.get('.el-select-dropdown.IpBlockStatus > .el-scrollbar > .el-select-dropdown__wrap > .el-scrollbar__view > :nth-child(4)').click()
      /* 조회 버튼 클릭 */
      cy.get('.searchBtnWrap > .el-button--primary').click()
      cy.wait('@viewListAsgnIPMst')
      /* 상세 버튼 클릭 */
      cy.get('tbody > :nth-child(1) > .el-table_2_column_17').dblclick()
      cy.wait('@viewDetailAsgnIPMst')
      /* 반납 버튼 클릭 */
