...
import com.ipsdn_opt.app.model.CommandServer;
...
public class ShellWorker {
    ...
    public ShellWorker(CommandServer cmdServer) throws Exception {
        ...
        try {
            ...
            password = cmdServer.getPassword();
    ...
    public String sendSudoCommand(String cmd, String sudoPrompt, long time_out) throws Exception {
        lastWorkTime = LocalDateTime.now();
        this.prompt = sudoPrompt;
        ps.println("sudo -i");
        ps.println(password);
        ps.println(cmd);
        String result = "";
