package com.nia.data.linkage.ai.service.impl.ipsdn.traffic;
...
import com.nia.data.linkage.ai.vo.ipsdn.traffic.LinkTrafficListVo;
...
public class IpSdnTrafficLinkageServiceImpl implements IpSdnTrafficLinkageService {
    ...
    public void sendTrafficData() {
        LOGGER.info("==========>[IpSdnTrafficLinkageService] sendPerfLogData <==============");
