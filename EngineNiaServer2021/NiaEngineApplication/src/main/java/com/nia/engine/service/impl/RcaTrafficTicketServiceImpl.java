...
import com.nia.engine.mapper.NodeFactorMapper;
import com.nia.engine.mapper.SdnTrafficMapper;
            ...
            if(sdnTrafficListVo != null && sdnTrafficListVo.getData().size() > 0) {
                ...
                while (itr.hasNext()) {
                    ...
                    if (faultTime.getTime() > time4.getTime()) {
                        ...
                        rcaTicketAl.setTicketId(ticketId);
                        rcaTicketAl.setRootCauseSysnameA(sdnTrafficInfoVo.getStrresnm());
