...
public interface TicketService {
    ...
    void updateSyslogAlarmState (HashMap<String, String> Map) throws Exception;
     ...
     * @return
     */
    List<RCATicket> selectRca48Ticket () throws Exception;
     ...
     * @return
     */
    List<RCATicket> selectRcaBefor5mTicket () throws Exception;

    List<SyslogAlarmVo> selectRcaBefor5mSyslog () throws Exception;
     ...
     * @return
     */
    void updateRcaTicketStatus (HashMap<String, String> Map) throws Exception;
    ...
    AiToEngineAnoVo selectAiTicketResult (String ticketId) throws Exception;
}
