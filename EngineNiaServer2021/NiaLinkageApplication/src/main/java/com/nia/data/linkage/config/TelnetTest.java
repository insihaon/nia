...
public class TelnetTest {
    ...
    @Autowired
	private org.springframework.beans.factory.ObjectFactory<StreamConnectorTest> streamConnectorTestObjectFactory;
    ...
    private StreamConnectorTest stdin_to_socket;
    private StreamConnectorTest socket_to_stdout;
    ...
    public TelnetTest(String host, int port){
        this.host = host;
        this.port = port;
    }
    ...
    public void sendCommand(String command, Boolean isFlush) throws RuntimeException {
        OutputStream out;
        String msg;
...
//                System.out.println("hex -> String : " + msg);
                ...
                out = new PrintStream(serverSocket.getOutputStream(), isFlush, "UTF-8");
...
//            stdin_to_socket = streamConnectorTestObjectFactory.getObject();
...
//            StreamConnector socket_to_stdout = new StreamConnector(serverInput, System.out);
            socket_to_stdout = streamConnectorTestObjectFactory.getObject();
...
@Component
@Scope(value = "prototype")
class StreamConnectorTest implements Runnable {
    ...
    public StreamConnectorTest(){
        super();
    }

    //  Constructor 입출력 스트림을 받아서 처리한다.
    public StreamConnectorTest(InputStream in, OutputStream out){
        src = in;
        dist = out;
    }
...
//                        continue;
//                    }else{
//                        LOGGER.info("=====> [StreamConnector] run host : "+host+" msg : "+str+" <=====");
//                    }
//                  //  LOGGER.info(str);
//                }
