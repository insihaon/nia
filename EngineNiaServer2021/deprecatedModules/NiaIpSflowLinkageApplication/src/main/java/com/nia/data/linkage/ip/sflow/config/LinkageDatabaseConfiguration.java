package com.nia.data.linkage.ip.sflow.config;

import com.nia.data.linkage.ip.sflow.vo.config.LinkageDatabaseConfigVo;
...
@Configuration
@MapperScan(value="com.nia.data.linkage.ip.sflow.mapper.linkage", sqlSessionFactoryRef="LinkageSqlSessionFactory")
