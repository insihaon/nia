...
import com.nia.ip.sdn.linkage.vo.config.LinkageDatabaseConfigVo;
...
@Configuration
@MapperScan(value="com.nia.ip.sdn.linkage.mapper.linkage", sqlSessionFactoryRef="LinkageSqlSessionFactory")
