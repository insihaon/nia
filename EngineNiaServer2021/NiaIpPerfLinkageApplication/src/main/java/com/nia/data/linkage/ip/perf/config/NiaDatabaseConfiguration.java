...
import com.nia.data.linkage.ip.perf.vo.config.NiaDatabaseConfigVo;
...
@Configuration
@MapperScan(value="com.nia.data.linkage.ip.perf.mapper.nia", sqlSessionFactoryRef="NiaSqlSessionFactory")
