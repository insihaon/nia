...
import com.nia.data.linkage.ip.equip.vo.config.LinkageDatabaseConfigVo;
...
@Configuration
@MapperScan(value="com.nia.data.linkage.ip.equip.mapper.linkage", sqlSessionFactoryRef="LinkageSqlSessionFactory")
