...
import com.nia.data.linkage.ip.alarm.vo.config.NiaDatabaseConfigVo;
...
@Configuration
@MapperScan(value="com.nia.data.linkage.ip.alarm.mapper.nia", sqlSessionFactoryRef="NiaSqlSessionFactory")
