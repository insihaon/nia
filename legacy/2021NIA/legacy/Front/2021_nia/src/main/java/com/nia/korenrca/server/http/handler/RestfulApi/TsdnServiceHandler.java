...
public class TsdnServiceHandler extends RequestHandler {
    private static Logger logger = LogManager.getLogger();
    public static final String Name = "/tsdn/selfconfig/service";

    public static Router create(Router router) {
        router.post(TsdnServiceHandler.Name).handler(new TsdnServiceHandler());
        return router;
    }
    ...
    protected Object handleJson(HttpServerRequest serverRequest, JsonObject json) {
        ...
        try {
            ...
            if(eventBusBridge != null){
                json.put("event_type", "TSDN_SERVICE_RESULT");
