...
import com.nia.korenrca.server.http.handler.impl.FormLoginHandlerImpl;
...
public interface FormLoginHandler extends Handler<RoutingContext> {
    ...
    static FormLoginHandler create(AuthProvider authProvider) {
        return new FormLoginHandlerImpl(authProvider, DEFAULT_USERNAME_PARAM, DEFAULT_PW_PARAM,
