    ...
    ; (function (global) {
        ...
        let Map2d = global.Map2d = function () {
            ...
            let defaultOptions = {
                ...
                node: { displayField: 'device_name', fix_size: false, displayImage: 'image', show_r: true, r: 30, width: 25, height: 30, badge_size: 30, drag_weight: 2, stroke_color: "#604c45", color: "#634d45", opacity: 0.7, text_size: 20 },
            ...
            /* objectCopyPrimitive 하나로 대체함. 문제 없으면 삭제 예정
            ...
            function objectCopy(target, source) {
                let sourceObj = deepClone(source);
                Object.keys(sourceObj).forEach(key => {
                    if (sourceObj[key] && typeof sourceObj[key] === 'object') {
                        objectCopy(target[key], sourceObj[key])
                    } else {
