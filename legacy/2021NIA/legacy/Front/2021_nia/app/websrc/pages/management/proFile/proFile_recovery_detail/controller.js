...
class RecoveryDetailCtrl extends BaseController {
    constructor($injector, $scope, tools, $http, $timeout, $mdDialog, $mdSelect, $element, param) {
        ...
        $scope.onMoveDialog = () => {
            const element = document.querySelector('#proFileRecoveryDetail');
...
RecoveryDetailCtrl.$inject = ['$injector', '$scope', 'tools', '$http', '$timeout', '$mdDialog', '$mdSelect', '$element', 'param'];

export default RecoveryDetailCtrl;
