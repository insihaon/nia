...
import com.nia.ems.linkage.vo.config.DatabaseConfigVo;
...
@Configuration
@MapperScan(basePackages= {"com.nia.ems.linkage"})
public class DatabaseConfiguration {
    ...
    public SqlSessionFactory getSqlSessionFactory() throws Exception{
        ...
        sqlSessionFactoryBean.setMapperLocations(applicationContext.getResources(databaseConfigVo.getMapperLocations()));
