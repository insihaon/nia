...
public class ServicePceOutputDataJsonVo implements Serializable {
    @JsonProperty("dst-tp-id")
    private String dstTpId;
    @JsonProperty("topology-id")
    private String topologyId;
    @JsonProperty("pce")
    private List<ServicePceOutputPceJsonVo> servicePceOutputPceJsonVoList;
    @JsonProperty("count")
    ...
    @JsonProperty("pce")
    public List<ServicePceOutputPceJsonVo> getServicePceOutputPceJsonVoList() {
        return servicePceOutputPceJsonVoList;
    }

    @JsonProperty("pce")
    public void setServicePceOutputPceJsonVoList(List<ServicePceOutputPceJsonVo> servicePceOutputPceJsonVoList) {
        this.servicePceOutputPceJsonVoList = servicePceOutputPceJsonVoList;
    }
