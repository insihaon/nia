...
import com.nia.data.linkage.ip.alarm.vo.config.LinkageDatabaseConfigVo;
...
@Configuration
@MapperScan(value="com.nia.data.linkage.ip.alarm.mapper.linkage", sqlSessionFactoryRef="LinkageSqlSessionFactory")
