package com.nia.ping.alarm.preprocessor.config;

import com.nia.ping.alarm.preprocessor.vo.config.DatabaseConfigVo;
...
@Configuration
@MapperScan(basePackages= {"com.nia.ping.alarm.preprocessor"})
