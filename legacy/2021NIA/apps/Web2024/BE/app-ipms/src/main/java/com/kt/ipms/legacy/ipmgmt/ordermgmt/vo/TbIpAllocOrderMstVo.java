...
public class TbIpAllocOrderMstVo extends IpVo implements Serializable {
	/** MEMBER VARIABLE DECLARATION START **/
	private static final long serialVersionUID = 91543082450312747L;

	private BigInteger nipAllocOrderSeq;
	...
	public BigInteger getNipAllocOrderSeq() {
		return nipAllocOrderSeq;
	}

	public void setNipAllocOrderSeq(BigInteger nipAllocOrderSeq) {
		this.nipAllocOrderSeq = nipAllocOrderSeq;
	}
	...
	public String getBflagStatus() {
		return bflagStatus;
	}

	public void setBflagStatus(String bflagStatus) {
		this.bflagStatus = bflagStatus;
	}
