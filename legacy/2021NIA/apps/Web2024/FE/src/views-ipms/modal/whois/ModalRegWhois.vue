<template>
  ...
  >
    <div v-loading="viewLoading">
        ...
        <table v-loading="tableLoading">
          ...
          <tbody>
            <tr>
              ...
              <th>한글 기관명(한 단어)</th>
              <td>
                <el-input v-model="userVo.sorgname" size="small" maxlength="200" />
              </td>
            </tr>
            <tr>
              <th>1b</th>
              <th>한글 주소</th>
              <td class="textflex">
                <el-input v-model="userVo.saddr" size="small" disabled maxlength="200" />
                <el-button type="primary" size="small" round @click="$refs.ModalSearchZipCode.open({ type: 'viewRegWhoisNew' })">주소검색</el-button>
              </td>
            </tr>
            <tr>
              <th>1c</th>
              <th>한글 상세 주소</th>
              <td>
                <el-input v-model="userVo.saddrDetail" size="small" disabled maxlength="200" />
              </td>
            </tr>
            <tr>
              <th>1d</th>
              <th>우편 번호</th>
              <td>
                <el-input v-model="userVo.szipcode" size="small" disabled />
              </td>
            </tr>
            <tr>
              <th>1e</th>
              <th>영문 기관명</th>
              <td>
                <el-input v-model="userVo.seorgname" size="small" maxlength="200" />
              </td>
            </tr>
            <tr>
              <th>1f</th>
              <th>영문 주소</th>
              <td>
                <el-input v-model="userVo.seaddr" size="small" disabled maxlength="200" />
              </td>
            </tr>
            <tr>
              <th>1g</th>
              <th>영문 상세 주소</th>
              <td>
                <el-input v-model="userVo.seaddrDetail" size="small" disabled maxlength="200" />
              </td>
            </tr>
            <tr>
              <th>1h</th>
              ...
              <td class="textflex" style="white-space: nowrap;">
                + 82 - <el-input v-model="userVo.sadmDpphone" size="small" maxlength="50" placeholder="2-222-2222" />
                <span style="color: #808080;font-size: 12px;margin-left: 8px;">(예: 2-222-2222)</span>
              </td>
            </tr>
            <tr>
              <th>1i</th>
              <th>전자우편주소</th>
              <td>
                <el-input v-model="userVo.sadmEmail" size="small" maxlength="100" />
              </td>
            </tr>
          </tbody>
        </table>
          ...
          <tbody>
            <tr>
              ...
              <td class="textflex" style="white-space: nowrap;">
                ...
                <el-input v-model="resultVo.sfirstAddr" size="small" disabled />
                <span>-</span>
                <span>End Address</span>
                <el-input v-model="resultVo.slastAddr" size="small" disabled />
              </td>
            </tr>
            <tr>
              <th>2b</th>
              <th>네트워크 이름(한 단어)</th>
              <td>
                <el-input v-model="resultVo.snetNm" size="small" disabled />
              </td>
            </tr>
            ...
            <tr>
              <th>2c</th>
              <th>네트워크분류</th>
              <td>{{ resultVo.snettype }}</td>
            </tr>
            <tr>
              <th>2d</th>
              <th>인터넷서비스분류</th>
              <td>{{ resultVo.sservicegb }}</td>
            </tr>
            <tr>
              <th>2e</th>
              <th>이용기관분류</th>
            ...
            <tr class="last">
              ...
              <th>연결 날짜</th>
              <td>
                <el-date-picker v-model="resultVo.dcreateDt" size="small" type="date" disabled />
        ...
        <table v-loading="tableLoading">
          ...
          <tbody>
            <tr>
              <th>추가사항 내용</th>
              <td>
                <el-input v-model="resultVo.ssvccommnet" size="small" type="textarea" rows="3" maxlength="1500" />
              </td>
            </tr>
          </tbody>
        </table>
        ...
        <table v-loading="tableLoading">
          ...
          <tbody>
            <tr>
              <th>결과 메세지</th>
              <td>
                <el-input v-model="resultVo.swhoisresultMsg" size="small" type="textarea" rows="5" readonly />
              </td>
            </tr>
          </tbody>
        </table>
      ...
      <div class="popupContentTableBottom">
        <el-button v-if="resultVo.dbMatchYn === 'N'" type="primary" size="small" round @click="fnSaveRegWhoisSubmit()">DB 현행화 전송</el-button>
        <el-button v-if="resultVo.swhoisresultCd === '03' || resultVo.delyn === 'N'" type="primary" size="small" icon="el-icon-edit-outline" round @click="fnSaveRegWhoisSubmit()">변경</el-button>
        <el-button v-if="resultVo.swhoisresultCd === '03' && resultVo.delyn === 'Y'" type="primary" size="small" round @click="fnDelRegWhoisSubmit()"> 삭제 </el-button>
...
export default {
  ...
  computed: {
    replaceSadmDpphone() {
      return this.userVo?.sadmDpphone ? this.userVo.sadmDpphone.replace('+82-', '') : ''
    }
  },
  methods: {
    onCreated() {
    ...
    async fnSaveRegWhoisSubmit(objVo = null) {
    ...
    setAddrForm(Addr) {
      const addrObj = {
        // userVo.saddr //한글 주소
        // userVo.saddrDetail //한글 상세 주소
        // userVo.szipcode //우편 번호
        // userVo.seaddr //영문 주소
        // userVo.seaddrDetail //영문 상세 주소
        saddr: Addr.newkaddr,
        saddrDetail: Addr.detailAddress,
        szipcode: Addr.zipcode,
        seaddr: Addr.eaddr,
        seaddrDetail: Addr.detailEAddress
      }
      Object.assign(this.userVo, addrObj)
    },
    onClose() {
      this.resultListVo = []
    },
