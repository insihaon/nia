...
public class DatabaseConfiguration2nd {
    ...
    @Value("${spring.datasource2nd.driver-class-name}")
	...
	@Value("${spring.mybatis.mapper-locations:classpath:/mapper/db2nd/**/*.xml}")
    ...
    @Value("${spring.datasource2nd.hikari.connectionTimeout:600000}")
	private long connectionTimeout;
	@Value("${spring.datasource2nd.hikari.maximumPoolSize:20}")
	private int maximumPoolSize;
	@Value("${spring.datasource2nd.hikari.maxLifetime:600000}")
	private long maxLifetime;
	@Value("${spring.datasource2nd.hikari.minimumIdle:10}")
	private int minimumIdle;
	@Value("${spring.datasource2nd.hikari.validationTimeout:30000}")
	private long validationTimeout;
	@Value("${spring.datasource2nd.hikari.idleTimeout:300000}")
	private long idleTimeout;
    @Value("${spring.jeus.enabled:false}")
	private String jndiEnable;
    @Value("${spring.datasource2nd.data-source-name:db2ndDataSource}")
	private String dataSourceName;

    private JndiDataSourceLookup lookup = new JndiDataSourceLookup();

    @Bean(name = "db2ndInterceptor")
    public SqlStatementInterceptor interceptor() {
        return new SqlStatementInterceptor();
    }

    @Bean(name = "db2ndDataSource")
    ...
    @Bean(name = "db2ndSqlSessionFactory")
    ...
    @Bean(name = "db2ndSqlSessionTemplate")
