...
public interface TicketMapper {
    ...
    //	SOP Timeout
    List<SopTimeoutVo> selectAiTimeoutTicket ();

    void insertSendTimeTicket (HashMap<String, String> map);

    void updateTimeoutTicket (HashMap<String, String> map);

    void deleteNotTimeoutData ();

    void deleteAiModelIsNotNullData (String ticketId);

    List<SopTimeoutVo> selectAllTimeoutTicket ();


    RCATicket selectTicket (String ticketId);
     ...
     * @return
     */
    List<RCATicket> selectRca48Ticket ();
     ...
     * @return
     */
    List<RCATicket> selectRcaBefor5mTicket ();
     ...
     * @return
     */
    List<SyslogAlarmVo> selectRcaBefor5mSyslog ();
     ...
     * @return
     */
    void updateRcaTicketStatus (HashMap<String, String> map);
     ...
     * @return
     */
    String selectTicketHandlingStatusCurrent (String ticketId);
    ...
    AiToEngineAnoVo selectAiTicketResult (String ticketId);
