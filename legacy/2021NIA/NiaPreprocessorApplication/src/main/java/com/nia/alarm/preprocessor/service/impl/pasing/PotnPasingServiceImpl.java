...
@Service("PotnPasingService")
@Scope(value = "prototype")
public class PotnPasingServiceImpl implements CommPasingService {
	private final static Logger LOGGER = Logger.getLogger(PotnPasingServiceImpl.class);
