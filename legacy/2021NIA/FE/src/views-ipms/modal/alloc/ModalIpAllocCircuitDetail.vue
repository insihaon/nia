...
export default {
  ...
  data() {
    return {
      ...
      resultVo: {
        'ssvc_line_type_cd': 'CL0003',
        'nip_alloc_mst_seq': 865865,
        'nip_alloc_neoss_seq': null,
        'sordernum': null,
        'sregyn': 'Y',
        'sodr_close_type_cd': null,
        'ssaid': '36032',
        'sllnum': '',
        'sicisofficescode': 'VV0015',
        'slacpsid': null,
        'ssubscnescode': null,
        'ssubscmstip': '110.70.230.1',
        'ssubsclgipportseq': null,
        ...
        'smodelname': 'CISCO',
        'scustname': null,
        'sip_version_type_cd': 'CV0001',
        'sip_create_type_cd': 'CT0001',
        'nip_assign_mst_seq': 980372,
        'pip_prefix': '1.100.0.0\/17',
        'sip_block': '1.100.0.0',
        'nbitmask': 17,
        'sfirst_addr': '1.100.0.0',
        'slast_addr': '1.100.127.255',
        'nipms_svc_seq': 0,
        'sassign_type_cd': 'SA1013',
        'sex_svc_cd': null,
        'ssvc_use_type_cd': 'SU0000',
        'sresult_cd': null,
        'sresult_msg': null,
        'sgatewayip': '1.100.127.254',
        'sinstalladdress': null,
        'sinstallroadaddress': null,
        'sex_push_yn': 'O',
        'nticket_act_seq': 0,
        'scomment': '',
        'dcreate_dt': '2022-07-12T00:41:56.000Z',
        'screate_id': '10149118',
        'dmodify_dt': '2022-07-12T00:41:56.000Z',
        'smodify_id': '10149118',
        'sreport_opinion': null,
        'sodrhopedt': null,
        'sodrregdt': null,
        'sofficecode': null,
        'ssvcUseTypeNm': 'N\/A',
  ...
  methods: {
    ...
    onOpen(model, actionMode) {
      this.onLoadCircuitDetail(model.nipAllocMstSeq)
    },
    onClose() {
    },
    async onLoadCircuitDetail(nipAllocMstSeq = null) {
      if (nipAllocMstSeq === null) return
      // try {
      //   const res = await api({ nlvlSeq: nipAllocMstSeq })
      // } catch (error) {
      //   this.error(error)
      // }
    },
