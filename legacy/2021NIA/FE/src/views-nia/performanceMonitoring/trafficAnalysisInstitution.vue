  ...
  computed: {
    trafficAgGrid() {
      ...
      const columns = [
        ...
        { type: '', model: 'packet_bytes', prop: 'packet_bytes', name: 'Gbyte', minWidth: 150, flex: 0, suppressMenu: true, alignItems: 'center', sortable: false, filterable: true, formatter: getFormatGbyte },
      ]
