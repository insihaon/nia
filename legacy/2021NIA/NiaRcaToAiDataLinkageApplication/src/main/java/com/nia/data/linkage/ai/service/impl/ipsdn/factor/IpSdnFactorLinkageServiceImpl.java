package com.nia.data.linkage.ai.service.impl.ipsdn.factor;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.nia.data.linkage.ai.common.SFTPSession;
import com.nia.data.linkage.ai.common.UtlCommon;
...
import com.nia.data.linkage.ai.vo.ipsdn.factor.NodeFactorListVo;
        ...
        try {
            ...
            if(StringUtils.isNotEmpty(dataKey)){
                ...
                if(nodeFactorVoList != null && nodeFactorVoList.size() > 0) {
                    ...
                    Comparator<NodeFactorVo> comparatorById  = Comparator.comparingInt(NodeFactorVo::getId);
                    ...
                    strHashMap.put("value", maxNodeFactorVo.getId()+"");
