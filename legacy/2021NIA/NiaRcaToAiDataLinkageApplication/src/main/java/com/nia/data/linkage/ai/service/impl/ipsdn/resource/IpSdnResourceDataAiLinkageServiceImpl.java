package com.nia.data.linkage.ai.service.impl.ipsdn.resource;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.nia.data.linkage.ai.common.SFTPSession;
import com.nia.data.linkage.ai.common.UtlDateHelper;
import com.nia.data.linkage.ai.mapper.ipsdn.IpsdnDataMapper;
...
import com.nia.data.linkage.ai.vo.ipsdn.resource.*;
...
public class IpSdnResourceDataAiLinkageServiceImpl implements IpSdnResourceLinkageService {
...
//    private org.springframework.beans.factory.ObjectFactory<IpCvnmsResourceIfListVo> ipCvnmsResourceIfListVoObjectFactory;
    ...
    public void sendNodeData() {
        LOGGER.info("==========>[IpSdnResourceLinkageService] sendNodeLinkData <==============");
...
//        String ftpUpdatePath = uploadPath+"tb_backbone_link/";
    ...
    public void sendLinkData() {
        ...
        try {
            ...
            LOGGER.error("=====> [IpSdnResourceLinkageService] sendPortData error() "+ ExceptionUtils.getStackTrace(e)+ "<=====");
        }
    }
